      ...
      {overBudget.length > 0 && (
        <div style={{
          ...
          <div style={{
            ...
            <svg width="12" height="12" fill="none" stroke="#D97706" strokeWidth="2" viewBox="0 0 24 24">
              <path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/>
              <line x1="12" y1="9" x2="12" y2="13"/>
              <line x1="12" y1="17" x2="12.01" y2="17"/>
            </svg>
            <span style={{ fontSize: 10.5, fontWeight: 700, color: '#D97706', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', padding: '8px 16px 12px' }}>
            {overBudget.map((p, i) => (
              <div key={p.id} style={{
                ...
                <span style={{ fontSize: 11.5, color: 'var(--text-primary)', fontWeight: 500 }}>{p.nama_pekerjaan}</span>
                <span style={{ fontSize: 10.5, color: '#D97706', fontWeight: 700, whiteSpace: 'nowrap', flexShrink: 0 }}>
